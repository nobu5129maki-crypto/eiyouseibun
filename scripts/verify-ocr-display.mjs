...
assert.match(pageSrc, /\['vitamin_c_mg', 'ビタミンC \(mg\)'\]/);
assert.match(pageSrc, /\['calcium_mg', 'カルシウム \(mg\)'\]/);
assert.match(pageSrc, /\['iron_mg', '鉄 \(mg\)'\]/);
assert.match(pageSrc, /vitamin_c_mg: Number\(nutrients\.vitamin_c_mg\)/);
assert.match(pageSrc, /calcium_mg: Number\(nutrients\.calcium_mg\)/);
assert.match(pageSrc, /iron_mg: Number\(nutrients\.iron_mg\)/);
